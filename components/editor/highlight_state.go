...
func (s *Screen) visibleBufferLines() (int, int) {
	if len(s.lines) == 0 {
		return 0, -1
	}
	if s.h <= 0 {
...
func (s *Screen) previewCovers(row int) bool {
...
func (s *Screen) highlightRefreshCmd(seq int, delay time.Duration) tea.Cmd {
...
func (s *Screen) handleHighlightWake(m editorHighlightMsg) core.Action {
...
func (s *Screen) handleHighlightReady(m editorHighlightReadyMsg) core.Action {
